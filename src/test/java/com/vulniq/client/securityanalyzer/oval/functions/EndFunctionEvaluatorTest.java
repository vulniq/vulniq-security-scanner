...
public class EndFunctionEvaluatorTest extends TerziTestBase
{
    ...
    @Test
    public void testEndFunctionEvaluator()
    {
        String absolutePath = new File("").getAbsolutePath();
        String ovalXMLPath = absolutePath + "/src/main/resources/unit-test-xml/oval-def_end_function.xml";
