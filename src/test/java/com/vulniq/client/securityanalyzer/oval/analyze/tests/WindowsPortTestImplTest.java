...
public class WindowsPortTestImplTest extends TerziTestUtilizingDocker
{
    ...
    @Test
    public void testPortTestOnHost()
    {
    ...
    @Test
    public void testPortTestOnDocker()
    {
        DataCollectionTarget dockerTarget = new DataCollectionTarget(DataCollectionTargetType.Docker, "terzi-windows");
        OSInfo dockerOSInfo = OSInfoCollector.getOSInfo(dockerTarget);
        ovalInterpreter = new OVALInterpreter("unit-test", dockerTarget, dockerOSInfo, false);
