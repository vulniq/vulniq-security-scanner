    ...
    extends StateType
{
    ...
    @XmlElement(name = "section_command", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#ios")
    protected EntityStateStringType sectionCommand;
    @XmlElement(name = "section_config_lines", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#ios")
