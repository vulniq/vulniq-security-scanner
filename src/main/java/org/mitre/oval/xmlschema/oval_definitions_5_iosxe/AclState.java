    ...
    extends StateType
{
    ...
    @XmlElement(name = "ip_version", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe")
    protected EntityStateAccessListIPVersionType ipVersion;
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe")
    protected EntityStateAccessListUseType use;
    @XmlElement(name = "used_in", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe")
    protected EntityStateStringType usedIn;
    @XmlElement(name = "interface_direction", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe")
    protected EntityStateAccessListInterfaceDirectionType interfaceDirection;
    @XmlElement(name = "acl_config_lines", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#iosxe")
