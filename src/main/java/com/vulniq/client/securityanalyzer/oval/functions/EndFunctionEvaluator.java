...
public class EndFunctionEvaluator extends FunctionEvaluatorBase
{
    
    private final EndFunctionType functionType;
    
    public EndFunctionEvaluator(EndFunctionType functionType, OVALInterpreter interpreter)
    {
        super(interpreter);
    ...
    private List<ComponentGroup> evaluateEndFunction(List<List<ComponentGroup>> cartesianProduct)
    {
        String endChar = functionType.getCharacter();
        ...
        for (List<ComponentGroup> groups : cartesianProduct)
        {
            ...
            {
                group.setValue(sb.toString() + endChar);
            }
    ...
    public List<ComponentGroup> evaluate() throws UnexpectedOVALEvaluationError
    {
        ...
        {
            return evaluateEndFunction(cartesianProduct);
        }
        else
        {
            ...
            return evaluateEndFunction(cartesianWithChildValues);
        }
    }
}
