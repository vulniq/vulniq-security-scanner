 ...
 * 
 */
public class Wmi57TestImplTest extends TerziTestBase
{
    ...
    public void testOfWmi57Test()
    {
        ...
        String ovalXMLPath = absolutePath + "/src/main/resources/unit-test-xml/win-def_wmi57_object_test.xml";
