...
public class UniqueFunctionEvaluatorTest extends TerziTestBase
{
    ...
    public UniqueFunctionEvaluatorTest()
    {
    }
    
    @Test
    public void testUniqueFunctionEvaluator()
    {
        String absolutePath = new File("").getAbsolutePath();
        String ovalXMLPath = absolutePath + "/src/main/resources/unit-test-xml/oval-def_unique_function.xml";
