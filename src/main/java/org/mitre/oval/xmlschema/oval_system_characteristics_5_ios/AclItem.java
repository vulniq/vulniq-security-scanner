    ...
    extends ItemType
{
    ...
    @XmlElement(name = "ip_version", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios")
    protected EntityItemAccessListIPVersionType ipVersion;
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios")
    protected EntityItemAccessListUseType use;
    @XmlElement(name = "used_in", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios")
    protected EntityItemStringType usedIn;
    @XmlElement(name = "interface_direction", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios")
    protected EntityItemAccessListInterfaceDirectionType interfaceDirection;
    @XmlElement(name = "acl_config_lines", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios")
    protected EntityItemStringType aclConfigLines;
    @XmlElement(name = "config_line", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios")
