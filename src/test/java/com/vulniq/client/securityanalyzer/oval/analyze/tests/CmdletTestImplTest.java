...
public class CmdletTestImplTest extends TerziTestBase
{
    ...
    public void testOfCmdletTest()
    {
        ...
        String ovalXMLPath = absolutePath + "/src/main/resources/unit-test-xml/cmdlet-unit-test.xml";
