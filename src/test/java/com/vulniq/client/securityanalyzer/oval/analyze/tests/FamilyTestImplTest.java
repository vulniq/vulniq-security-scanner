...
public class FamilyTestImplTest extends TerziTestUtilizingDocker
{
    private OVALInterpreter ovalInterpreter;

    @Test
    public void testFamilyTestOnHostWindows()
    {
        ...
        String ovalXMLPath = absolutePath + "/src/main/resources/unit-test-xml/ind-def_family_test-windows.xml";
    ...
    @Test
    public void testFamilyTestOnDockerWindows()
    {
        //Run these tests only on windows
        Assume.assumeTrue(TerziTestSetup.isOnWindows());
