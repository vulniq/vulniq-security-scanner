 ...
 *
 */
public class RegistryTestImpl extends TestImplBase
{

    RegistryTest testDefinition;

    public RegistryTestImpl(OVALInterpreter interpreter, RegistryTest registryTest)
    {
        super(interpreter, registryTest);
        this.testDefinition = registryTest;
    }
