...
public class RpmInfoTestImpl extends TestImplBase
{
    private RpminfoTest testDefinition;

    public RpmInfoTestImpl(OVALInterpreter interpreter, RpminfoTest test)
    {
