 ...
 * 
 */
public class RpmVerifyFileTestImpl extends TestImplBase
{
    private RpmverifyfileTest testDefinition;

    public RpmVerifyFileTestImpl(OVALInterpreter interpreter, RpmverifyfileTest test)
    {
