...
public class DpkginfoTestImpl extends TestImplBase
{
    private DpkginfoTest testDefinition;


    public DpkginfoTestImpl(OVALInterpreter interpreter, DpkginfoTest test)
    {
