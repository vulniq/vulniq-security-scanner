...
@XmlType(name = "CriteriaType", namespace = "http://oval.mitre.org/XMLSchema/oval-results-5", propOrder = {
    "criteriaOrCriterionOrExtendDefinition"
})
public class CriteriaType {

    @XmlElements({
        @XmlElement(name = "criteria", namespace = "http://oval.mitre.org/XMLSchema/oval-results-5", type = CriteriaType.class),
        @XmlElement(name = "criterion", namespace = "http://oval.mitre.org/XMLSchema/oval-results-5", type = CriterionType.class),
        @XmlElement(name = "extend_definition", namespace = "http://oval.mitre.org/XMLSchema/oval-results-5", type = ExtendDefinitionType.class)
    })
