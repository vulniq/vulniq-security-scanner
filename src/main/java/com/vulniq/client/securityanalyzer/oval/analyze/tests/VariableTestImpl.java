 ...
 * 
 */
public class VariableTestImpl extends TestImplBase
{
    private VariableTest testDefinition;

    public VariableTestImpl(OVALInterpreter interpreter, VariableTest test)
    {
