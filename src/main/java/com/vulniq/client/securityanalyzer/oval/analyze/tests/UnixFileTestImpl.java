...
public class UnixFileTestImpl extends TestImplBase
{

    private FileTest fileTest;

    public UnixFileTestImpl(OVALInterpreter interpreter, TestType testType)
    {
    ...
    {
        return fileTest.getObject().getObjectRef();
    }

    @Override
    public List<StateRefType> getStateRefs()
    {
        return fileTest.getState();
    }
