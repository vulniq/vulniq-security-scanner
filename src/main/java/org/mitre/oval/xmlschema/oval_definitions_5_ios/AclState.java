    ...
    extends StateType
{
    ...
    @XmlElement(name = "ip_version", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#ios")
    protected EntityStateAccessListIPVersionType ipVersion;
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#ios")
    protected EntityStateAccessListUseType use;
    @XmlElement(name = "used_in", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#ios")
    protected EntityStateStringType usedIn;
    @XmlElement(name = "interface_direction", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#ios")
    protected EntityStateAccessListInterfaceDirectionType interfaceDirection;
    @XmlElement(name = "acl_config_lines", namespace = "http://oval.mitre.org/XMLSchema/oval-definitions-5#ios")
