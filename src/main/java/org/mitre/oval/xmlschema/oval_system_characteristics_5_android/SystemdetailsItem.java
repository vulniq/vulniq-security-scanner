    ...
    extends ItemType
{
    ...
    @XmlElement(name = "cpu_abi", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#android")
    protected EntityItemStringType cpuAbi;
    @XmlElement(name = "cpu_abi2", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#android")
    protected EntityItemStringType cpuAbi2;
    @XmlElement(name = "build_fingerprint", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#android")
    protected EntityItemStringType buildFingerprint;
    @XmlElement(name = "os_version_code_name", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#android")
    protected EntityItemStringType osVersionCodeName;
    @XmlElement(name = "os_version_build_number", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#android")
    protected EntityItemStringType osVersionBuildNumber;
    @XmlElement(name = "os_version_release_name", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#android")
    protected EntityItemStringType osVersionReleaseName;
    @XmlElement(name = "os_version_sdk_number", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#android")
    protected EntityItemIntType osVersionSdkNumber;
    @XmlElement(name = "hardware_keystore", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#android")
