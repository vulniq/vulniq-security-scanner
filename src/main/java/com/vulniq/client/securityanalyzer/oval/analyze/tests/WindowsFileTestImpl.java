 ...
 *
 */
public class WindowsFileTestImpl extends TestImplBase
{

    private FileTest testDefinition;

    public WindowsFileTestImpl(OVALInterpreter interpreter, FileTest test)
    {
