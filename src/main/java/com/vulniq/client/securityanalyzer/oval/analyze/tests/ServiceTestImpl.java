...
public class ServiceTestImpl extends TestImplBase
{
    private ServiceTest testDefinition;
    
    public ServiceTestImpl(OVALInterpreter interpreter, ServiceTest test)
    {
