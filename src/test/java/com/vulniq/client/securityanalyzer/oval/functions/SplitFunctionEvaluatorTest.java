...
public class SplitFunctionEvaluatorTest extends TerziTestBase
{
    ...
    public void testSplitFunction()
    {
        ...
        String ovalXMLPath = absolutePath + "/src/main/resources/unit-test-xml/oval-def_split_function.xml";
