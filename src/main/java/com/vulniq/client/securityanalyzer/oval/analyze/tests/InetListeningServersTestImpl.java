 ...
 * 
 */
public class InetListeningServersTestImpl extends TestImplBase
{
    private InetlisteningserversTest testDefinition;

    public InetListeningServersTestImpl(OVALInterpreter interpreter, InetlisteningserversTest test)
    {
