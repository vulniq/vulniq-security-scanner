 ...
 *
 */
public class ConcatFunctionEvaluatorTest extends TerziTestBase
{
    ...
    public ConcatFunctionEvaluatorTest()
    {
    }
    
    @Test
    public void testConcatFunctionEvaluator()
    {
        String absolutePath = new File("").getAbsolutePath();
        String ovalXMLPath = absolutePath + "/src/main/resources/unit-test-xml/oval-def_concat_function.xml";
