...
@XmlRootElement(name = "oval_directives", namespace = "http://oval.mitre.org/XMLSchema/oval-directives-5")
public class OvalDirectives {

    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-directives-5", required = true)
    protected GeneratorType generator;
    @XmlElement(namespace = "http://oval.mitre.org/XMLSchema/oval-directives-5", required = true)
    protected DefaultDirectivesType directives;
    @XmlElement(name = "class_directives", namespace = "http://oval.mitre.org/XMLSchema/oval-directives-5")
