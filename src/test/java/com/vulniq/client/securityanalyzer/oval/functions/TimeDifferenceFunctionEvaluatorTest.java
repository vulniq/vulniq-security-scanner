...
public class TimeDifferenceFunctionEvaluatorTest extends TerziTestBase
{
    ...
    @Test
    public void testTimeDifferenceFunction()
    {
        String absolutePath = new File("").getAbsolutePath();
        String ovalXMLPath = absolutePath + "/src/main/resources/unit-test-xml/oval-def_time_difference_function.xml";
    ...
    public void testValues()
    {
        ...
        for (int index = 16; index < variables.size(); index++)
        {
