...
public class WindowsServiceTestImplTest extends TerziTestBase
{
    ...
    @Test
    public void evaluateServiceTestImpl()
    {
        ...
        String ovalXMLPath = absolutePath + "/src/main/resources/unit-test-xml/win-def_service_test.xml";
