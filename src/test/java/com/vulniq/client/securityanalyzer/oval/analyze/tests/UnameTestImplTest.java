 ...
 * 
 */
public class UnameTestImplTest extends TerziTestBase
{
    OVALInterpreter ovalInterpreter;
    DataCollectionTarget hostOSTarget;
    OSInfo hostOSInfo;
    
    public UnameTestImplTest()
    {
    }
    ...
    /**
     * Test of class UnameTestImpl.
     */
    @Test
    public void testOfUnameTestImpl()
    {

        String absolutePath = new File("").getAbsolutePath();
        String ovalXMLPath = absolutePath + "/src/main/resources/unit-test-xml/unix-def_uname_test.xml";
