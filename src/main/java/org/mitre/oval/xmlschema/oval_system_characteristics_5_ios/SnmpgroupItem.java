    ...
    extends ItemType
{
    ...
    @XmlElement(name = "ipv4_acl", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios")
    protected EntityItemStringType ipv4Acl;
    @XmlElement(name = "ipv6_acl", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios")
    protected EntityItemStringType ipv6Acl;
    @XmlElement(name = "read_view", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios")
    protected EntityItemStringType readView;
    @XmlElement(name = "write_view", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios")
    protected EntityItemStringType writeView;
    @XmlElement(name = "notify_view", namespace = "http://oval.mitre.org/XMLSchema/oval-system-characteristics-5#ios")
